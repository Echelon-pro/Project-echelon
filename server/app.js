...
// Configure CORS
const corsOptions = {
    origin: ['http://localhost:5000', 'http://127.0.0.1:5000', 'https://project-echelon.com', 'http://project-echelon.com'],
...
app.use((req, res, next) => {
    ...
    // Skip static files
    if (Object.keys({}).some(prefix => req.path.startsWith(prefix))) {
        return next();
    }
